            ...
            .then(
                (result) => {
                    ...
                    result.forEach(hold => {
                        ...
                        let h = { ID: hold.ID, Score: hold.Score, Sends: parsedSends, TotalValue: hold.TotalValue, VersionAdded: hold.VersionAdded, Units: parsedUnits, Wave: waveVal, Workers: hold.Workers, Player: hold.Player };
                        parsedHolds.push(h);
                    })
